...
@WebServlet(name = "admin_uploadfile",urlPatterns = {"/admin_uploadfile"})
public class admin_uploadfile extends HttpServlet 
{
        ...
        if(ServletFileUpload.isMultipartContent(request))
        {
            ...
            {                                    
                ...
                {                    
                    ...
                    out.println("<br />Writting completed");
                     try
                    {
                    ...
                    if(st.executeUpdate(qry)==1)
                    {
                        ...
                        out.println("<br /><br /><a href='admin_utext.jsp' >Add Caption</a>");
                    }
                    else
                    {
