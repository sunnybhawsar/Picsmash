          ...
          try
                 {
                    ...
                    String qry="select * from fileinfo where mid='"+id+"' order by pid desc";
                    ...
                    while(rs.next())
                    {
                      ...
                      out.println("</table>");
                      out.println("<a href='delete.jsp?itemid="+rs.getString(1)+"' style='float:right; margin-top:0px; margin-right:20%;color:black; text-decoration:none;'><h3>Delete Post</h3></a> <a href='editfile.jsp?fileid="+rs.getString(1)+"' style='float:right; margin-top:0px; margin-right:30px;color:black; text-decoration:none;'><h3>Edit Post</h3></a>");
                    ...
                    out.println("<br/><br/><br/><br/><a href='user.jsp'><h2>Back to Profile</h2></a>");
                 }catch(Exception sk)
                 {
